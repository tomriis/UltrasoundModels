function [data] = horizontalGeometryScan3D(x)
    ...
    for i = 1:length(Plane_XYZ)
        [max_hp, sum_hilbert, xdc_data]=horizontal_array_simulation(42, 6, x(1), x(2),[6,6]/1000, focus,...,
                'kerf',x(3),'R_focus',(x(1)-x(2))*x(4)+x(2),'Plane',Plane_XYZ{i},'excitation', excitation);
